    ...
    <table>
      ...
      <%     
       ...
       <% if (Roles.IsUserInRole("user"))
          {%>
        <td>
            <%= Html.ActionLink(ViewRes.ImovelStrings.inserefotos, "InsereFotos", new { id = item.imovel.id })%>
            <br />
            <%= Html.ActionLink(ViewRes.ImovelStrings.editar, "Editar", new { id = item.imovel.id })%>
            <br />
            <%= Html.ActionLink(ViewRes.ImovelStrings.apagar, "ApagarImovel", new { id = item.imovel.id })%>
            <br />
            <%= Html.ActionLink(ViewRes.ImovelStrings.globalize, "Globalizar", new { id = item.imovel.id })%>
         </td>
         <%} %>

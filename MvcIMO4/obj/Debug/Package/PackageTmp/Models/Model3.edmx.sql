...
-- --------------------------------------------------
-- Date Created: 11/02/2010 17:27:01
...
GO
IF OBJECT_ID(N'[dbo].[FK_imovel_objectivo_imovels]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[imovel_objectivo] DROP CONSTRAINT [FK_imovel_objectivo_imovels];
GO
IF OBJECT_ID(N'[dbo].[FK_imovel_objectivo_objectivoes]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[imovel_objectivo] DROP CONSTRAINT [FK_imovel_objectivo_objectivoes];
GO
...
GO
IF OBJECT_ID(N'[dbo].[imovel_objectivo]', 'U') IS NOT NULL
    DROP TABLE [dbo].[imovel_objectivo];
GO
...
-- Creating table 'imovel_objectivo'
CREATE TABLE [dbo].[imovel_objectivo] (
    [id] int  NOT NULL,
    [imovel_id] int  NOT NULL,
    [objectivoes_id] int  NOT NULL
);
GO
...
-- Creating primary key on [id] in table 'imovel_objectivo'
ALTER TABLE [dbo].[imovel_objectivo]
ADD CONSTRAINT [PK_imovel_objectivo]
    PRIMARY KEY CLUSTERED ([id] ASC);
GO
...
-- Creating foreign key on [imovel_id] in table 'imovel_objectivo'
ALTER TABLE [dbo].[imovel_objectivo]
ADD CONSTRAINT [FK_imovel_objectivo_imovels]
    FOREIGN KEY ([imovel_id])
    REFERENCES [dbo].[imovels]
        ([id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_imovel_objectivo_imovels'
CREATE INDEX [IX_FK_imovel_objectivo_imovels]
ON [dbo].[imovel_objectivo]
    ([imovel_id]);
GO

-- Creating foreign key on [objectivoes_id] in table 'imovel_objectivo'
ALTER TABLE [dbo].[imovel_objectivo]
ADD CONSTRAINT [FK_imovel_objectivo_objectivoes]
    FOREIGN KEY ([objectivoes_id])
    REFERENCES [dbo].[objectivoes]
        ([id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_imovel_objectivo_objectivoes'
CREATE INDEX [IX_FK_imovel_objectivo_objectivoes]
ON [dbo].[imovel_objectivo]
    ([objectivoes_id]);
GO
